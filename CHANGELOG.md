...
- **Stronger ProgramFacts fuzzing** — oracle validation now covers all generated policies at boundary sizes, metamorphic transforms that preserve declared facts, feedback-directed samples across canonical JSON commands, visualization block invariants, clone-backed smell checks, and a replayable stress script with saved failure corpora.
