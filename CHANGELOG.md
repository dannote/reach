...
- **Stronger ProgramFacts fuzzing** — oracle validation now covers all generated policies at boundary sizes, metamorphic transforms that preserve declared facts, and feedback-directed samples across canonical JSON commands.
